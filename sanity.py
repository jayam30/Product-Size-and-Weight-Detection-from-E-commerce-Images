...
if __name__ == "__main__":
    ...
    parser.add_argument("test_filename", type=str,help="The test CSV file name.")
    parser.add_argument("output_filename", type=str, help="The output CSV file name to check.")
